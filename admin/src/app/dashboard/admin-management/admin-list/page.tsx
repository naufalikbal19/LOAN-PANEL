...
export default function AdminListPage() {
  ...
  const select = (style?: React.CSSProperties) => ({
    style: { background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: 8, padding: "10px 32px 10px 12px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit", appearance: "none" as const, ...style },
  });
    ...
    <div>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          ...
          <p style={{ color: "#888", fontSize: 13 }}>Urus akaun pentadbir dan kakitangan</p>
        </div>
      ...
      <form onSubmit={handleSearch} style={{ display: "flex", gap: 8, marginBottom: 20, maxWidth: 400 }}>
        <div style={{ position: "relative", flex: 1 }}>
          ...
          <input value={inputSearch} onChange={(e) => setInputSearch(e.target.value)} placeholder="Cari nama atau e-mel..." style={{ background: "#111", border: "1px solid #2e2e2e", borderRadius: 8, padding: "9px 12px 9px 32px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
        </div>
      ...
      <div style={{ background: "#111", border: "1px solid #1e1e1e", borderRadius: 14, overflow: "hidden" }}>
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan={7} style={{ textAlign: "center", padding: 40, color: "#555" }}>Memuatkan...</td></tr>
              ) : admins.length === 0 ? (
                <tr><td colSpan={7} style={{ textAlign: "center", padding: 40, color: "#555" }}>Tiada rekod dijumpai.</td></tr>
              ) : admins.map((a, i) => {
                ...
                return (
                  <tr key={a.id} style={{ borderTop: "1px solid #1a1a1a", background: i % 2 === 0 ? "transparent" : "#0a0a0a" }}>
                    <td style={{ padding: "13px 16px", color: "#555", fontSize: 11 }}>{a.id}</td>
                    <td style={{ padding: "13px 16px" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                        ...
                        <span style={{ fontWeight: 600, color: "#fff" }}>{a.name}{isSelf && <span style={{ marginLeft: 6, fontSize: 10, color: "#c9a84c", fontWeight: 700 }}>(Anda)</span>}</span>
                      </div>
                    </td>
                    <td style={{ padding: "13px 16px", color: "#888" }}>{a.email}</td>
                    <td style={{ padding: "13px 16px" }}>
                    ...
                    <td style={{ padding: "13px 16px", color: "#666", whiteSpace: "nowrap", fontSize: 12 }}>{new Date(a.created_at).toLocaleDateString("ms-MY")}</td>
                    <td style={{ padding: "13px 16px" }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 24 }}>
          <div style={{ background: "#111", border: "1px solid #2e2e2e", borderRadius: 16, padding: 28, width: "100%", maxWidth: 420 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              ...
              <button onClick={() => setShowAdd(false)} style={{ background: "none", border: "none", cursor: "pointer", color: "#666", display: "flex" }}><X size={18} /></button>
            </div>
            {addError && <p style={{ color: "#ef4444", fontSize: 13, marginBottom: 12 }}>{addError}</p>}
            {(["name", "email"] as const).map((key) => (
              <div key={key} style={{ marginBottom: 14 }}>
                <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>{key === "name" ? "Nama" : "E-mel"}</label>
                <input value={addForm[key]} onChange={(e) => setAddForm((p) => ({ ...p, [key]: e.target.value }))} type={key === "email" ? "email" : "text"} style={{ background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: 8, padding: "10px 12px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
              </div>
            ))}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>Kata Laluan</label>
              <div style={{ position: "relative" }}>
                <input value={addForm.password} onChange={(e) => setAddForm((p) => ({ ...p, password: e.target.value }))} type={showAddPass ? "text" : "password"} placeholder="Min. 6 aksara" style={{ background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: 8, padding: "10px 40px 10px 12px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
                <button onClick={() => setShowAddPass(!showAddPass)} style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#555", display: "flex" }}>{showAddPass ? <EyeOff size={15} /> : <Eye size={15} />}</button>
              </div>
            </div>
            <div style={{ marginBottom: 20 }}>
              <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>Peranan</label>
              <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
              <button onClick={() => setShowAdd(false)} style={{ background: "#1e1e1e", border: "none", borderRadius: 8, padding: "9px 18px", fontSize: 13, color: "#888", cursor: "pointer", fontFamily: "inherit" }}>Batal</button>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 24 }}>
          <div style={{ background: "#111", border: "1px solid #2e2e2e", borderRadius: 16, padding: 28, width: "100%", maxWidth: 420 }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              ...
              <button onClick={() => setEditAdmin(null)} style={{ background: "none", border: "none", cursor: "pointer", color: "#666", display: "flex" }}><X size={18} /></button>
            </div>
            {editError && <p style={{ color: "#ef4444", fontSize: 13, marginBottom: 12 }}>{editError}</p>}
            {(["name", "email"] as const).map((key) => (
              <div key={key} style={{ marginBottom: 14 }}>
                <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>{key === "name" ? "Nama" : "E-mel"}</label>
                <input value={editForm[key]} onChange={(e) => setEditForm((p) => ({ ...p, [key]: e.target.value }))} type={key === "email" ? "email" : "text"} style={{ background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: 8, padding: "10px 12px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
              </div>
            ))}
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>Kata Laluan Baru (kosongkan jika tidak tukar)</label>
              <div style={{ position: "relative" }}>
                <input value={editForm.password} onChange={(e) => setEditForm((p) => ({ ...p, password: e.target.value }))} type={showEditPass ? "text" : "password"} placeholder="Min. 6 aksara" style={{ background: "#1e1e1e", border: "1px solid #2e2e2e", borderRadius: 8, padding: "10px 40px 10px 12px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
                <button onClick={() => setShowEditPass(!showEditPass)} style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "#555", display: "flex" }}>{showEditPass ? <EyeOff size={15} /> : <Eye size={15} />}</button>
              </div>
            </div>
            <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
              ...
              <div style={{ flex: 1 }}>
                <label style={{ fontSize: 11, color: "#666", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", display: "block", marginBottom: 5 }}>Status</label>
                <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
              <button onClick={() => setEditAdmin(null)} style={{ background: "#1e1e1e", border: "none", borderRadius: 8, padding: "9px 18px", fontSize: 13, color: "#888", cursor: "pointer", fontFamily: "inherit" }}>Batal</button>
      ...
      {deleteId && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100, padding: 24 }}>
          <div style={{ background: "#111", border: "1px solid #2e2e2e", borderRadius: 16, padding: 28, width: "100%", maxWidth: 340, textAlign: "center" }}>
            ...
            <p style={{ color: "#888", fontSize: 13, marginBottom: 24 }}>Tindakan ini tidak boleh dibatalkan.</p>
            <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
              <button onClick={() => setDeleteId(null)} style={{ background: "#1e1e1e", border: "none", borderRadius: 8, padding: "9px 22px", fontSize: 13, color: "#888", cursor: "pointer", fontFamily: "inherit" }}>Batal</button>
