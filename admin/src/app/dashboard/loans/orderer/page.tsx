    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 12, marginBottom: 20 }}>
        <div style={{ position: "relative", flex: 1, maxWidth: 360 }}>
          ...
          <input placeholder="Cari permohonan..." style={{ background: "#161616", border: "1px solid #242424", borderRadius: 10, padding: "10px 12px 10px 36px", color: "#fff", fontSize: 13, width: "100%", outline: "none", fontFamily: "inherit" }} />
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            <thead>
              <tr style={{ background: "#0c0c0c" }}>
                {["ID Pinjaman", "Pemohon", "Jumlah", "Tempoh", "Status", "Tarikh Mohon", "Tindakan"].map((h) => (
            ...
            <tbody>
              <tr>
                <td colSpan={7} style={{ padding: "48px 20px", textAlign: "center", color: "#666" }}>
                  <div style={{ fontSize: 32, marginBottom: 12 }}>📋</div>
                  <p style={{ fontSize: 14, fontWeight: 600, marginBottom: 4 }}>Tiada permohonan</p>
